...
//          if(oldPath.size > 3){
//            zoomToChildren(modelRW, oldPath.init.init) match {
//              case Some(rw) =>
//                println(oldPath.init.last)
//                rw.value.foreach(println)
//                rw.value.find(retrieveEntity(_).uuid.toString == oldPath.init.last) match {
//                  case Some(foundElem) =>
//                    println(foundElem)
//                    if(foundElem.isRelation) {
//                      if(foundElem.asInstanceOf[Relation].submodel.children.isEmpty){
//                        println(rw.value)
////                        updated(rw.updated(rw.value :+ foundElem.asInstanceOf[Relation].entity).tree)
//                        noChange
//                      } else {
//                        noChange
//                      }
