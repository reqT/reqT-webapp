...
object ReqTLog {
  ...
  case class Props(proxy: ModelProxy[Tree], stateSaveTree: Tree => Unit, openNewModelModal: String => Callback)
  ...
  class Backend($: BackendScope[Props, State]) {
    ...
    //saveTree borde importeras i Props för reqTLog
...
//      $.accessDirect.modState(_.saveTree(tree))
  ...
  def apply(proxy: ModelProxy[Tree], stateSaveTree: Tree => Unit, openNewModelModal: String => Callback)
